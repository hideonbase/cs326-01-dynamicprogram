...
//From JY
app.use('/newser/signup', express.static('../newser/signup'));
app.use('/newser/signin', express.static('../newser/signin'));
app.use('/newser/userinfo',express.static('../newser/userinfo'));
//End from JY
